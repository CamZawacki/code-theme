;; doom-cambox-theme.el --- inspired by morhetz Gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)
...
;;
(defgroup doom-cambox-theme nil
  "Options for doom-gruvbox."
  :group 'doom-themes)

(defcustom doom-cambox-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-cambox-theme
  :type 'boolean)

(defcustom doom-cambox-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-cambox-theme
  :type '(choice integer boolean))

(defcustom doom-cambox-dark-variant nil
...
;;
(def-doom-theme doom-cambox
  "Dark theme with pastel 'retro groove' colors."

  ;; name        gui       256       16
  ((bg
    (cond ((equal doom-cambox-dark-variant "hard") '("#1d2021" "#1e1e1e" nil))   ; bg0_h
          ((equal doom-cambox-dark-variant "soft") '("#32302f" "#323232" nil))   ; bg0_s
          (t                                        '("#211F1C" "#211F1C" nil)))) ; bg0
   (bg-alt
    (cond ((equal doom-cambox-dark-variant "hard") '("#0d1011" "black" nil))     ; (self-defined)
          ((equal doom-cambox-dark-variant "soft") '("#281111" "#282828" nil))   ; bg0
        (t                                        '("#1f1d19" "#171614" nil)))) ; bg_h
   (bg-alt2    '("#171614" "#504945" "brown"      )) ; bg2 (for region, selection etc.)

   (base0      '("#0d1011" "black"   "black"      )) ; (self-defined)
   (base1      '("#1d2021" "#1d1d1d" "brightblack")) ; bg0_h
   (base2      '("#282828" "#211F1C" "brightblack")) ; bg0
   (base3      '("#1c1a18" "#383838" "brightblack")) ; bg1
   (base4      '("#665c54" "#6c5c5c" "brightblack")) ; bg3
   (base5      '("#7c6f64" "#7f6f6f" "brightblack")) ; bg4
   (base6      '("#928374" "#928374" "brightblack")) ; gray
   (base7      '("#cccccc" "#cccccc" "brightblack")) ; fg2
   (base8      '("#0bfbfb" "#fbfbfb" "brightwhite")) ; fg0
   (fg         '("#a99a89" "#a99a89" "brightwhite")) ; fg/fg1
   (fg-alt     '("#666666" "#000000" "black")) ; fg2
   (whte       '("#a99a89", "a99a89" "white")) ; curser

   ;; Standardized official colours from gruvbox
   (grey        '("#5f574e" "#5f574e" "brightblack"))   ; gray
   (red         '("#8a382e" "#69271f" "red"))           ; bright-red
   (magenta     '("#814b70" "#cc241d" "magenta"))       ; red
   (violet      '("#614573" "#d3869b" "brightmagenta")) ; bright-purple
   (orange      '("#99561f" "#fd971f" "orange"))        ; bright-orange
   (yellow      '("#9f8a2d" "#fabd2f" "yellow"))        ; bright-yellow
   (dark-yellow '("#675a1d" "#fabd2f" "yellow"))        ; yellow
   (teal        '("#8ec07c" "#8ec07c" "green"))         ; bright-aqua
   (green       '("#616c41" "#b8bb26" "green"))         ; bright-green
   (dark-green  '("#3f462a" "#98971a" "green"))         ; green
   (blue        '("#516762" "#83a598" "brightblue"))    ; bright-blue
   (dark-blue   '("#35433f" "#458588" "blue"))          ; blue
   (cyan        '("#3b7d6d" "#8ec07c" "brightcyan"))    ; bright-aqua
   (dark-cyan   '("#2a594d" "#689d6a" "cyan"))          ; aqua
   ...
   (selection      bg-alt2)
   (builtin        orange)
   (comments       (if doom-cambox-brighter-comments magenta grey))
   (doc-comments   (if doom-cambox-brighter-comments (doom-lighten magenta 0.2) (doom-lighten bg-alt 0.25)))
   (constants      violet)
   (functions      green)
   (methods        green)
   (keywords       red)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-cambox-padded-modeline
      (if (integerp doom-cambox-padded-modeline)
          doom-cambox-padded-modeline
        4)))
   (modeline-bg bg-alt2)
  ...
  ((button :foreground cyan :underline t :weight 'bold)
   ...
   (company-tooltip-mouse :background bg-alt2)
   ...
   ;;;; show-paren <built-in>
   ((show-paren-match &override) :background base5 :bold t)
   ((show-paren-mismatch &override) :background "red")
   ;;;; swiper
...
;;; doom-cambox-theme.el ends here
